...
public interface StarRocksConstants {
    ...
    interface CsvFormat {
        ...
        byte[] COLUMN_DELIMITER_BYTE =
                StarRocksDelimiterParser.parse(COLUMN_DELIMITER).getBytes(StandardCharsets.UTF_8);
        ...
        String LINE_PATTERN = "%s" + StarRocksDelimiterParser.parse(LINE_DELIMITER);
    }
