...
public class StreamLoadResponse implements Serializable {
    ...
    public void setFlushBytes(final long flushBytes) {
        this.flushBytes = flushBytes;
    }

    public void setFlushRows(final long flushRows) {
        this.flushRows = flushRows;
    }

    public void setCostNanoTime(final long costNanoTime) {
        this.costNanoTime = costNanoTime;
    }

    public void setBody(final StreamLoadResponseBody body) {
        this.body = body;
    }
    ...
    public static class StreamLoadResponseBody implements Serializable {
        ...
        public void setExistingJobStatus(final String existingJobStatus) {
        ...
        public void setNumberTotalRows(final Long numberTotalRows) {
            this.numberTotalRows = numberTotalRows;
        }

        public void setNumberLoadedRows(final Long numberLoadedRows) {
            this.numberLoadedRows = numberLoadedRows;
        }

        public void setNumberFilteredRows(final Long numberFilteredRows) {
            this.numberFilteredRows = numberFilteredRows;
        }

        public void setNumberUnselectedRows(final Long numberUnselectedRows) {
        ...
        public void setLoadBytes(final Long loadBytes) {
            this.loadBytes = loadBytes;
        }

        public void setLoadTimeMs(final Long loadTimeMs) {
            this.loadTimeMs = loadTimeMs;
        }

        public void setBeginTxnTimeMs(final Long beginTxnTimeMs) {
            this.beginTxnTimeMs = beginTxnTimeMs;
        }

        public void setStreamLoadPlanTimeMs(final Long streamLoadPlanTimeMs) {
            this.streamLoadPlanTimeMs = streamLoadPlanTimeMs;
        }

        public void setReadDataTimeMs(final Long readDataTimeMs) {
            this.readDataTimeMs = readDataTimeMs;
        }

        public void setWriteDataTimeMs(final Long writeDataTimeMs) {
            this.writeDataTimeMs = writeDataTimeMs;
        }

        public void setCommitAndPublishTimeMs(final Long commitAndPublishTimeMs) {
