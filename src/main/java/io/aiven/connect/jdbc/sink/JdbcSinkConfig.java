...
public class JdbcSinkConfig extends JdbcConfig {
    ...
    static {
        // Database
        int orderInGroup = 0;
        defineConnectionHost(CONFIG_DEF, orderInGroup);
        defineConnectionPort(CONFIG_DEF, orderInGroup);
        defineConnectionDatabase(CONFIG_DEF, orderInGroup);
        defineConnectionSSL(CONFIG_DEF, orderInGroup);
