...
public class JdbcConfig extends AbstractConfig {
    ...
    public static final String CONNECTION_HOST_DEFAULT = "localhost";
    private static final String CONNECTION_HOST_DOC = "Connection Host";
    private static final String CONNECTION_HOST_DISPLAY = "Connection Host";

    public static final String CONNECTION_PORT = "connection.port";
    public static final int CONNECTION_PORT_DEFAULT = 8040;
    private static final String CONNECTION_PORT_DOC = "Connection Port";
    private static final String CONNECTION_PORT_DISPLAY = "Connection Port";

    public static final String CONNECTION_DATABASE = "connection.database";
    public static final String CONNECTION_DATABASE_DEFAULT = "database";
    private static final String CONNECTION_DATABASE_DOC = "Connection Database";
    private static final String CONNECTION_DATABASE_DISPLAY = "Connection Database";

    public static final String CONNECTION_SSL = "connection.ssl";
    public static final boolean CONNECTION_SSL_DEFAULT = false;
    private static final String CONNECTION_SSL_DOC = "Connection SSL";
    private static final String CONNECTION_SSL_DISPLAY = "Connection SSL";
    ...
    public final String getConnectionHost() {
        return getString(CONNECTION_HOST);
    }

    public final int getConnectionPort() {
        return getInt(CONNECTION_PORT);
    }

    public final String getConnectionDatabase() {
        return getString(CONNECTION_DATABASE);
    }

    public final boolean getConnectionSSL() {
        return getBoolean(CONNECTION_SSL);
    }
    ...
    public final String getConnectionPassword() {
        return getString(CONNECTION_PASSWORD_CONFIG);
    }
    ...
    protected static void defineConnectionHost(final ConfigDef configDef, final int orderInGroup) {
        configDef.define(
            CONNECTION_HOST,
    ...
    protected static void defineConnectionPort(final ConfigDef configDef, final int orderInGroup) {
        configDef.define(
            CONNECTION_PORT,
            ConfigDef.Type.INT,
    ...
    protected static void defineConnectionDatabase(final ConfigDef configDef, final int orderInGroup) {
        configDef.define(
            CONNECTION_DATABASE,
            ConfigDef.Type.STRING,
    ...
    protected static void defineConnectionSSL(final ConfigDef configDef, final int orderInGroup) {
        configDef.define(
            CONNECTION_SSL,
