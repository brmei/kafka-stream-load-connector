...
public class JdbcDbWriterTest {
    ...
    private JdbcDbWriter newWriter(final Map<String, String> props) {
        ...
        return new JdbcDbWriter(config);
    }
    ...
    public void shouldGenerateNormalizedTableNameForTopic() {
        ...
        // final JdbcDbWriter jdbcDbWriter = new JdbcDbWriter(jdbcSinkConfig);
    ...
    //     final JdbcDbWriter writer = new JdbcDbWriter(jdbcSinkConfig);
